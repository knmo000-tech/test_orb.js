        ...
        18: [function (_dereq_, module, exports) {
            ...
            var defaultToolbarConfig = {
                exportToExcel: function (pgridComponent, button) {
                    ...
                    // ★追加：config.toolbar.exportToExcel があればそれを優先
                    var cfg = pgridComponent && pgridComponent.props && pgridComponent.props.pgridwidget
                        ? pgridComponent.props.pgridwidget.pgrid.config
                        : null;

                    if (cfg && cfg.toolbar && typeof cfg.toolbar.exportToExcel === 'function') {
                        return cfg.toolbar.exportToExcel(pgridComponent, button);
                    }
